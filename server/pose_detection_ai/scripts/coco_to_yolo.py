...
# when run must use command --coco_json_path 'C:\Users\22017111\OneDrive - Republic Polytechnic\c290\C300_AIFirstResponders\server\pose_detection_ai\datasets\annotations\<something>.json' --yolo_save_root_dir 'C:\Users\22017111\OneDrive - Republic Polytechnic\c290\C300_AIFirstResponders\server\pose_detection_ai\datasets\train\labels'
# 
